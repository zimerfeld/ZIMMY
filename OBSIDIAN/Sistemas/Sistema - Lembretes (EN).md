...
and reuses the **scheduler clock** from [[Sistema - Automações e Agendador (EN)]].
...
## Reuse — `_parse_schedule_str()` (zimmy.gd:1767)
...
Related: [[Sistema - Automações e Agendador (EN)]], [[Entrada - Itens do Menu (EN)]], [[Home (EN)]].
