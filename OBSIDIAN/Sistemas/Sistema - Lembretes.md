...
o **relógio do agendador** de [[Sistema - Automações e Agendador]].
...
## Reuso — `_parse_schedule_str()` (zimmy.gd:1767)
...
Relacionado: [[Sistema - Automações e Agendador]], [[Entrada - Itens do Menu]], [[Home]].
