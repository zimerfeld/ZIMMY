...
- 🇬🇧 **Outlook/Hotmail**: generate an _App password_ at [account.microsoft.com/security](https://account.microsoft.com/security). **Corporate Microsoft 365** accounts usually have IMAP/basic **disabled** by the admin — then it does not work.
- 🇧🇷 **Outlook/Hotmail**: gere uma _Senha de aplicativo_ em [account.microsoft.com/security](https://account.microsoft.com/security). Contas **Microsoft 365 corporativas** costumam ter IMAP/básico **desativado** pelo admin — aí não funciona.
