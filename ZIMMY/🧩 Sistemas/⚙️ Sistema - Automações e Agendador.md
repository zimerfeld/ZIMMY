...
## ⏱️ Agendador — `_parse_schedule()` (zimmy.gd:1462)
...
`alarme.gd` (daily@08:00), `comemoracao_hora_cheia.gd` (hourly — dispara **fogos de
artifício** via `zimmy.celebrate()`, ver [[✨ Sistema - Animação]]), `desligar_pc.gd`
