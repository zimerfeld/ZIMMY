...
## 🏷️ Tipos (esquema em [[🗂️ Glossário de Configs]])
Originais:
...
Categorias extras (≈14, sorteadas **de forma independente**, cada uma com cor própria):
...
## 🎛️ Controles (3 independentes) — [[🧭 Sistema - Menu de Contexto]]
